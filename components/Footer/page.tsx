      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-1 text-gray-400">
            ...
            <li><Link href="/Ekstra" className="hover:text-white">Ekstrakurikuler</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-1 text-gray-400">
            ...
            <li className="flex items-center gap-2">
              <Instagram size={14} />
              <a href="https://www.instagram.com/sman17bone" target="_blank" className="hover:text-white">
                @sman17bone
              </a>
            </li>
          </ul>
